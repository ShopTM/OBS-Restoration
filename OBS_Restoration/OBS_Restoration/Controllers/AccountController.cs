...
namespace OBS_Restoration.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model)
        {
            ...
            SignInStatus result;
            if (UserManager.IsUserLocked(model.Email))
            {
                result = SignInStatus.LockedOut;
            }
            else result = await SignInManager.PasswordSignInAsync(model.Email, model.Password, model.RememberMe, shouldLockout: false);
            switch (result)
            {
